...
#define CUBE		(unsigned char)0b00001000
#define PAINTED		(unsigned char)0b00000100
#define CACHED		(unsigned char)0b00000010
#define NOCUBE		(unsigned char)0b00000001
#define NONE		(unsigned char)0b00000000

#define CUDA_CUBE		(unsigned char)0x008
#define CUDA_PAINTED	(unsigned char)0x004
#define CUDA_CACHED		(unsigned char)0x002
